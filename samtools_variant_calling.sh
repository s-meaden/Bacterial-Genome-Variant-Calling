...
samtools mpileup -uf $ref 20170801_Meaden1/alignments/*dedup.bam -D | bcftools view -bvcg - > var.raw.bcf
# Have ommitted -D100 step.
bcftools view var.raw.bcf | /usr/share/samtools/vcfutils.pl varFilter > var.flt.vcf
